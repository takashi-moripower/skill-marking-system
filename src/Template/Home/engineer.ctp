...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-7">
                <dl>
                    ...
                    <dt>解説</dt>
                    <dd>
                        作品の説明、自己アピールなど自由に記載してください<br/>
                        動画、写真などは、YouTube、Instagramなどへのリンクを付けることができます
                    </dd>
                    <dt>添付ファイル</dt>
                    <dd>
        ...
        <ul>
            <li>投稿した作品についてスキルを登録し、１～５段階で自己評価して下さい。</li>
            <li>作品の自己評価したスキルに対して、学校の先生か業界の方が評価します。</li>
