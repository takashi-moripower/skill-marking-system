 ...
 * Example 2:
 * //RGBを16進数で設定する。
 * $color = Color::rgb(0xFF0066);
 * echo $color->r; // 255
 * 
 * Example 3:
 * //HSV色空間で色を設定する。
 * $color = Color::hsv(100, 0.5, 0.2);
 * echo $color->s; // 0.5
 * echo $color->hsv; // 'hsv(100, 0.5,0.2)'
 * 
 * Example4
 * //RGBを16進数で設定し、16進数で値を取得する。
 * $color = Color::rgb(0xFF0099);
 ...
 * $color = Color::rgb(155,200,60);
 * $color2->v = $color2->v * 0.8;
 * echo $color->rgb; // '7ba02f'
 * 
 * Example7
 * //Alphaを使う
 * $color = Color::argb(0.5, 155, 200, 60);
 * $color = Color::ahsv(0.5, 300.5, 200, 60);
 * echo $color->a; // 0.5
...
class Color {
    ...
    public function imagecolorallocatealpha($imageResource) {
        return imagecolorallocatealpha(
                $imageResource, $this->_r, $this->_g, $this->_b, ((int) (127 - $this->_a * 127))
        );
    }
    ...
    public function imagecolorallocate($imageResource) {
        ...
        return imagecolorallocate(
                $imageResource, $this->_r, $this->_g, $this->_b
        );
    }
