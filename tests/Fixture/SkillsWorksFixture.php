 ...
 *
 */
class SkillsWorksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_skills_works_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_skills_works_works1_idx' => ['type' => 'index', 'columns' => ['work_id'], 'length' => []],
        ],
        '_constraints' => [
